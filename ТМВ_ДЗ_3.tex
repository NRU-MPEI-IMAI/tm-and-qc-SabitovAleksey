...
\begin{enumerate}
    ...
    \begin{center}
    Начало
        \includegraphics[scale=0.75]{1_1_1.png}
    \newpageКонец
        \includegraphics[scale=0.75]{1_1_2.png} 
    \end{center}  \newpage
    \item Умножение унарных чисел (1 балл)
    \begin{center}
    Начало
        \includegraphics[scale=0.75]{1_2_1.png}\newpage
    Конец
        \includegraphics[scale=0.73]{1_2_2.png} 
    \end{center}    
\end{enumerate}
...
\begin{enumerate}
    \item Принадлежность к языку $L = \{ 0^n1^n2^n \}, n \ge 0$ (0.5 балла)
        \begin{center}
    Начало
        \includegraphics[scale=0.75]{2_1_1.png}\newpage
    Конец
        \includegraphics[scale=0.73]{2_1_2.png} 
    \end{center}\newpage
    ...
    \begin{center}
    Начало
        \includegraphics[scale=0.6]{2_2_1.png}\newpage
    Конец
        \includegraphics[scale=0.6]{2_2_2.png} 
    \end{center}
...
\end{enumerate}
    ...
    Схема для случая |0000\rangle;|1011\rangle: \newline
        \includegraphics[scale=1]{3_1.jpg}
    \end{center} \newline
Код:\newline
\begin{lstlisting}
namespace Solution {
